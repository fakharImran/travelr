            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="admin_box">
                      ...
                      @endif
                      <form method="POST" action="{{route("appuser.update", $id)}}">
                            @method('PUT')
                            @csrf
                              ...
                              <div class="user_form_box">
                                  ...
                                  <div class="user_form_content">
                                    ...
                                    <div class="user_input_form">
                                        <input type="text"  class="form-control" id="first_name" value="{{$appUserData['first_name']}}" name="first_name" required autocomplete="first_name"   >
                                      @error('first_name')
                                ...
                                <div class="user_form_content">
                                    ...
                                    <div class="user_input_form">
                                        <input type="text"  class="form-control" id="last_name"  value="{{$appUserData['last_name']}}" name="last_name" required autocomplete="last_name"   >
                                      @error('last_name')
                                          <span class="invalid-feedback" role="alert">
                                              <strong>{{ $message }}</strong>
                                          </span>
                                ...
                                <div class="user_form_content">
                                    ...
                                    <div class="user_input_form">
                                      <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" value="{{$appUserData->user->email}}" name="email" autocomplete="email" required>
                                      @error('email')
                                          <span class="invalid-feedback" role="alert">
                                              <strong>{{ $message }}</strong>
                                          </span>
                                ...
                                <div class="user_form_content">
                                      ...
                                      <div class="user_input_form">
                                        <input type="number" class="form-control"  pattern="\d{11}" id="phone_no" name="phone_no" value="{{$appUserData->user->phone_no}}" required autocomplete="phone_no" autofocus  placeholder="Telephone">
                                      </div>
                                  </div>
                                ...
                                <div class="user_form_content">
                                    ...
                                    <div class="user_input_form">
                                        <input id="password" type="password" class="form-control @error('password') is-invalid @enderror" value="{{$appUserData->user->password}}" name="password" required  placeholder="Password">
