            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="admin_box">
                      ...
                      @endif
                      <form method="POST" action="{{route("setting.update", $currentUser->id)}}">
                            @method('PUT')
                            @csrf
                              ...
                              <div class="user_form_box">
                                  <div class="user_form_content">
                                    ...
                                    <div class="user_input_form">
                                        <input type="text"  class="form-control" id="name" value="{{$currentUser['name']}}" name="name" required autocomplete="name"   >
                                      @error('name')
                                ...
                                <div class="user_form_content">
                                    ...
                                    <div class="user_input_form">
                                      <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" value="{{$currentUser['email']}}" name="email" autocomplete="email" required>
                                      @error('email')
                                          <span class="invalid-feedback" role="alert">
                                              <strong>{{ $message }}</strong>
                                          </span>
                                ...
                                <div class="user_form_content">
                                      ...
                                      <div class="user_input_form">
                                        <input type="number" class="form-control"  pattern="\d{11}" id="phone_no" name="phone_no" value="{{$currentUser['phone_no']}}" required autocomplete="phone_no" autofocus  placeholder="Telephone">
                                      </div>
                                  </div>
                                ...
                                <div class="user_form_content">
                                    ...
                                    <div class="user_input_form">
                                        <input id="password" type="password" class="form-control @error('password') is-invalid @enderror" value="{{$currentUser['passhowd']}}" name="password" required  placeholder="Password">
