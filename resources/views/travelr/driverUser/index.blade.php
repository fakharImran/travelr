...
<div class="container" style="padding:0px">
    ...
    <div class="row" style="   max-width: 99%; margin: 1px auto;">
        <div class="col-md-12 col-12">
            <div class="Company" style="text-align: center;" >Driver User
            </div>
  ...
  @endif
    ...
    <div class="col-12">
            <div class="table_btn_list">
                ...
                <div class="add_btn">
                    <a href="{{ route('driver.create') }}"> <span>+</span>Insert</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-12" style="margin: 1px auto; ">
            <table id="customDataTable" class="table  datatable table-bordered table-hover table-responsive nowrap" style="width:100%; font-size: small;">
                ...
                <tbody>
                    @if($driverUsers!=null)
                    @foreach ($driverUsers as $appUser)
                        <tr>
                            ...
                            <td class="tdclass">
                                ...
                                <form action={{ route('driver.destroy', $appUser['id']) }} method="post">
                                    @csrf
                                    @method('DELETE')

                                    <button class="submit delete-button"><i class="fa fa-trash-o text-danger" aria-hidden="true"></i>
                                    </button>
                                    <a href="{{ route('driver.edit',   $appUser['id']) }}"><i class="fa fa-pencil-square-o text-secondary" aria-hidden="true"></i>
                                    </a>
                                </form>
