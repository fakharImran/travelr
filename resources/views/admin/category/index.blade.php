        ...
        <div class="col-12">
            <div class="table_btn_list">
                ...
                <div class="select_field">
                    <select class="clickable-element" id="name-search" onclick= "setRecord()">
                ...
                <div class="search_bar">
                    ...
                    <input id="customSearchInput" onchange="setRecord()" type="text" placeholder="">
                    </div>
...
<script>
    function setRecord() {
      var customDataTable = $('#customDataTable').DataTable();

      var totalRecords = customDataTable.rows().count();

      var visibleRecords = customDataTable.rows({ search: 'applied' });
      var count =  visibleRecords.count();

      console.log('Total Records:', totalRecords);
      console.log('Visible Records after Filter:', count);
      $('.custom-table-info').text(count+ ' records in total');
    }
    </script>
