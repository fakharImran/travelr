...
<div class="container  marketing-activity">
    ...
    <div class="row pt-5" style="margin: 1px auto; font-size: 12px;">
        ...
        <div class="col-12">
            ...
            <div class="table-responsive" >
                    {{-- table-responsive --}}
                    {{-- nowrap --}}
                <table id="marketingActivityDataTable" class="table table-sm  datatable table-hover  " style="border: 1px solid #ccc; min-width: 1580px; ">
                    <thead>
                        <tr>
...
<script src="{{ asset('assets/js/marketingActivityDatatable.js') }}"></script>
...
<script>
    ...
    function downloadTable(table) {
        ...
        link.setAttribute('download', 'Marketing_Activity_table.csv');
    ...
    document.getElementById('downloadButton').addEventListener('click', () => {
        const timeSheetTable = document.getElementById('marketingActivityDataTable');
